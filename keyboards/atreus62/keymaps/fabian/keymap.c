...
[_DEFAULT] = { /* qwerty */
		...
		{ KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_TRNS,         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    CH_UE },
		{ KC_LCTL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_TRNS,         KC_H,    KC_J,    KC_K,    KC_L,    CH_OE,   CH_AE },
		{ KC_LSFT,  CH_Y,    KC_X,    KC_C,    KC_V,    KC_B,    KC_BSPC,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSHIFT },
		{ KC_LCTL,  KC_LGUI, KC_LALT, KC_GRV,  MO(_NAV),KC_ESC,          KC_ENT, KC_SPC,  KC_EQL,  KC_MINS, KC_QUOT, KC_ENT,  KC_RGUI }
},
